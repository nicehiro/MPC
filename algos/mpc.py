...
class MPC:
    ...
    def __init__(self, config, dynamic, rewards):
        ...
        self.sampler = self.samplers[mpc_config['sampler']](self.upper_bound, self.lower_bound,
                                                            self.action_dim, self.is_discrete)
    ...
    def plan(self, state):
        ...
        actions = self.sampler.sample_n(sample_nums=self.sample_times,
        ...
        if self.is_cem:
            ...
            elites = actions[idx][:self.num_elites]
