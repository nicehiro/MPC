...
if __name__ == '__main__':
    ...
    if not (nn_config['model_config']['load_model'] and reward_config['model_config']['load_model']):
        pretrained_episode = 40
        logging.info('Random sample actions from env and fit the dynamic and reward model.')
        for _ in range(pretrained_episode):
            ...
            while not d:
                ...
                o_, r, d, _ = env.step(a)
                logging.debug('Random sampled state-action pairs: {}'.format([o, a, r, d, o_]))
